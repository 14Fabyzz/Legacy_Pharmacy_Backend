...
public class StockDTO {
    ...
    private BigDecimal precioVentaBase; // Precio por Caja (Sin IVA)
    private BigDecimal precioVentaTotal; // PVP Caja (Con IVA) -> NUEVO
    private BigDecimal ivaPorcentaje; // % IVA -> NUEVO
