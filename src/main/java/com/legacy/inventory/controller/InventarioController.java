...
import com.legacy.inventory.dto.EntradaMercanciaDTO;
import com.legacy.inventory.service.InventarioService;
...
public class InventarioController {
    ...
    @PostMapping("/salida")
    public ResponseEntity<?> registrarSalida(@RequestBody @Valid com.legacy.inventory.dto.SalidaMercanciaDTO salidaDTO) {
        try {
